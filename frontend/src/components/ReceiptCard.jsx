...
import {
  ...
  ArrowUp, ArrowDown, Loader2, ImageOff, Square,
} from 'lucide-react'
...
export default function ReceiptCard({ receipt, onRefresh, selected, onToggle, bulkMode }) {
  ...
  // bulkMode: parent has at least 1 item selected → all cards show checkbox UI
  const selectionMode = !!bulkMode
    ...
    <>
      <article
        ...
        style={{
          background: '#0D1525',
          boxShadow: selected
            ? '0 0 0 1.5px rgba(16,185,129,0.55), 0 2px 6px rgba(0,0,0,0.4)'
            : cardShadow(receipt.status),
        }}
      >
        {/* ── Collapsed Row ─────────────────────────── */}
        <div
          ...
          aria-expanded={open}
        >
          {/* Checkbox (selection mode) or Thumbnail */}
          <div className="shrink-0">
            {selectionMode ? (
              <div
                className="w-[52px] h-[52px] rounded-[7px] flex items-center justify-center"
                style={{
                  background: selected ? 'rgba(16,185,129,0.15)' : 'rgba(100,150,255,0.05)',
                  boxShadow: selected
                    ? '0 0 0 1.5px rgba(16,185,129,0.5)'
                    : '0 0 0 0.5px rgba(100,150,255,0.09)',
                }}
              >
                <div
                  ...
                  style={{
                    ...
                    boxShadow: selected ? 'none' : '0 0 0 1.5px rgba(100,150,255,0.25)',
                  }}
                >
                  {selected && (
          ...
          <div className="shrink-0 flex items-center gap-2">
            ...
            {!selectionMode && (
              <>
                {/* Select button (enters bulk mode) */}
                <button
